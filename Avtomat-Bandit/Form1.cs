...
namespace Avtomat_Bandit
{
    ...
    {
        int balance = 500; //Исходный баланс.
        ...
        private void dvg3_Tick(object sender, EventArgs e)
        {
            ...
            player.SoundLocation = @"glass.wav";
            player.Load();
            player.Play();
    }
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            stop3.Enabled = true;
            IsActive = true; 
            button1.Enabled = true; //Пока барабаны крутятся кнопка "Погнали!"  заблокирована.
        }
